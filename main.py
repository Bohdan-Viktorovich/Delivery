...
# --- Настройки ---
BOT_TOKEN = "8790174040:AAGwdpPvrjj70VtVwgcHKG6ti9_LrHgNsEo"
ADMIN_ID = 7262437300
...
# Временное хранилище языка пользователя
user_lang = {}
...
async def process_cargo_details(message: types.Message, state: FSMContext):
    ...
    # Логика расчета цены
    delivery_price = t['price_fixed'] # Здесь можно добавить более сложную логику, например, зависящую от типа груза
