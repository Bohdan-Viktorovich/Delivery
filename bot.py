...
LANGUAGES = {
    'ru': {
        ...
        'ask_pickup': "📍 Укажите адрес, откуда забрать груз (улица, дом):",
    ...
    'ro': {
        ...
        'ask_pickup': "📍 Indicați adresa de ridicare (stradă, număr):",
    ...
    'en': {
        ...
        'ask_pickup': "📍 Enter the pickup address (street, building):",
